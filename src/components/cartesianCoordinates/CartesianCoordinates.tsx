      ...
      <>
        <defs>
          <GridPattern
            ...
            xLines={this.xAxis.line}
            yLines={this.yAxis.line}
          ></GridPattern>
        </defs>
        <rect
          fill={`url(#${this.id})`}
          width={this.width}
          height={this.height}
          x={this.scaleX(this.minX)}
          y={this.scaleY(this.maxY)}
        ></rect>
        <line
          x1={10000000}
          x2={-10000000}
          y1={0}
          y2={0}
          style={{ stroke: "var(--m-grid-axis-color)" }}
        ></line>
        <line
          x1={0}
          x2={0}
